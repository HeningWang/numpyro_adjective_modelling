"""Run the full 2x2 (speaker x semantics) experiment with the
csv=0.59 / fsv=0.50 / wf=0.6856 / k=0.5 semantic constants.

All four cells use the reported model structure (single alpha, log_beta,
tau, delta). The colour-sufficient joint refit on the contextual model
prefers colour-semval near 0.59, and fsv=0.50 / k=0.5 / wf=0.6856 are the
fixed-constant best values. This tests whether the speaker x semantics
interaction holds under the corrected representation. run_2x2_best_repr.py
(csv=0.85, fsv=0.70, wf=1.0) is kept for the head-to-head comparison.
...
# Fixed-constant set (supersedes the csv=0.85/fsv=0.70/wf=1.0 grid).
...
sep = "=" * 80
print("\n" + sep)
print("2x2 RESULTS (csv=0.59, fsv=0.50, wf=0.6856, k=0.5)")
print(sep)
