...
save_csp_pdf(p,'figures/simulation_controlled_comparison.pdf',8.2,3.9)
ggsave('figures/simulation_controlled_comparison.png',p,width=8.2,height=3.9,units='in',dpi=180)
