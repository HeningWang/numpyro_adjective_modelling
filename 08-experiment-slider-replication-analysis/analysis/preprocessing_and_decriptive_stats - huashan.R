...
p <- ggplot(ratings_aggregated, aes(x=combination, y=prefer_first_1st, fill=relevant_property)) +
  ...
  ggtitle("Mittelwerte der Akzeptabilit?tswerte f?r Pr?ferenzen der ersten Adjektiven aus Kombinationen \n an der Position I in der scharfen oder unscharfen Gr??enverteilung")+
