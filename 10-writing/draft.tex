...
The present paper builds directly on that work.
...
Before turning to the experiments, we describe the framework at a conceptual level; its formal specification, including all equations and inference details, is deferred to the Computational Model section (\Cref{sec:model}).
...
We do not claim that production-level incrementality is required for adjective-ordering preferences in general; the subjectivity literature and our own simulations indicate that context-sensitive restrictive composition already accounts for much of the canonical tendency.
