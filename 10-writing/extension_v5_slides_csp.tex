...
\begin{itemize}\itemsep0.3em
  ...
  \item Lapse $\varepsilon = 0.22$ --- nearly a quarter of responses as uniform noise.
\end{itemize}
...
\vspace{0.5em}
\emp{But}: seven memo \S5.3 misfits persist; $\varepsilon = 0.22$ uncomfortably high.
\end{frame}
...
\begin{itemize}\itemsep0.15em
  ...
  \item Every add-on moves metrics monotonically in the right direction except v5b (sat $\gamma$ alone) which is null.
\end{itemize}
\end{frame}
