...
def posterior_analysis():
    ...
    result_dict = {}
    filename = '../posterior_samples/production_posterior_full_gb_10k_4p.csv'
    ...
    df_pred.to_csv('../posterior_samples/production_posteriorPredictive_full_gb_10k_4p.csv', index=False)
